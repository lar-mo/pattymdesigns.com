...
function parseJson(ls_strings) {
    ...
    try {
      ...
      document.querySelector("#pancake-link-about-shop").innerHTML = array["header_link_about_shop"];
      document.querySelector("#pancake-link-about-me").innerHTML   = array["header_link_about_me"];
      document.querySelector("#pancake-link-portfolio").innerHTML  = array["header_link_portfolio"];
      document.querySelector("#pancake-link-contact").innerHTML    = array["header_link_contact"];
      ...
      document.querySelector("#header-link-special").innerHTML    = array["header_link_special"];
      document.querySelector(".featured-item-image").innerHTML    = array["featured_item_image"];
      document.querySelector(".featured-item-text").innerHTML     = array["featured_item_text"];
    }
